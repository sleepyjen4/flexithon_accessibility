// Exercise demo clips live in public/graphics/<name>.{webm,mp4}, generated by
// scripts/generate-exercise-video.mjs from the 1080² GIF masters in
// assets/exercise-gifs/ (kept out of public/ so they are not served). A few clip file
