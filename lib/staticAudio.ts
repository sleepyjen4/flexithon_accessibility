...
export const STATIC_CLIPS = {
  ...
  calibrate_seated_arm_raise:
    "Seated Lateral Raise. Here's what happens. Sit so your head and arms are in view. Sit in a supported position. Raise one arm toward a comfortable range. Lower your arm when you are ready. Repeat gently 3 times. We'll do the measuring.",
